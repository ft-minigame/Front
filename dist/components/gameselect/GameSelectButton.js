...
exports.GameSelectButton = function (_a) {
    var defaultThumbnail = _a.defaultThumbnail, _src = _a.src, restProps = __rest(_a, ["defaultThumbnail", "src"]);
    ...
    return (react_1.default.createElement(Button, __assign({ onMouseOver: onMouseOver, onMouseLeave: onMouseLeave }, restProps),
